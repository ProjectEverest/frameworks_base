...
public class EverestThemeController {

    private static final String TAG = "EverestThemeController";
    private final ContentResolver mContentResolver;
    private final Handler mBackgroundHandler;
    private Context mContext;

    public EverestThemeController(Context context, Handler backgroundHandler) {
    ...
    public void observeSystemSettings(Runnable reevaluateSystemThemeCallback) {
        observeSystemSettings(reevaluateSystemThemeCallback, EverestSettingsConstants.SYSTEM_SETTINGS_KEYS);
    }
